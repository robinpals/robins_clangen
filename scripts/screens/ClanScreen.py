...
class ClanScreen(Screens):
    ...
    def screen_switches(self):
        ...
        self.nursery_label = pygame_gui.elements.UIImage(scale(pygame.Rect(self.layout['nursery'], (160, 56))),
                                                         pygame.transform.scale(
                                                             ...
                                                             (160, 56)))
        if game.clan.game_mode == 'classic' or not game.clan.clan_settings["freshkill"]:
    ...
    def choose_cat_positions(self):
        ...
        for x in game.clan.clan_cats:
            ...
            if Cat.all_cats[x].status in ['apprentice', 'mediator apprentice', 'starteller apprentice', 'defense apprentice', 'attack apprentice', 'hunt apprentice']:
                Cat.all_cats[x].placement = self.choose_nonoverlapping_positions(first_choices, all_dens,
                                                                                 [1, 50, 1, 1, 100, 100, 1])
