...
class Patrol():
    ...
    def add_patrol_cats(self, patrol_cats: List[Cat], clan: Clan) -> None:
        ...
        for cat in patrol_cats:
            ...
            if cat.status == 'apprentice' or cat.status == 'medicine cat apprentice' or cat.status == 'starteller apprentice' or cat.status == 'defense apprentice' or cat.status == 'attack apprentice':
            ...
            if cat.status in ("apprentice", "defense apprentice", "attack apprentice", "medicine cat apprentice", "starteller apprentice"):
